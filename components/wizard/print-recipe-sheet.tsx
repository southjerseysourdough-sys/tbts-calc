    ...
    >
      <article className="recipe-sheet__paper">
        ...
        <div className="recipe-sheet__content">
          <section className="recipe-sheet__section">
            <div className="recipe-sheet__section-heading">
              <h2 className="recipe-sheet__section-title">Oil Breakdown</h2>
              <p className="recipe-sheet__section-kicker">Percentages and weights for each oil</p>
            </div>
            <div className="recipe-sheet__list">
              {result.oils.map((oil) => (
                <div key={oil.oilId} className="recipe-sheet__list-row">
                  <span className="recipe-sheet__list-label">
                    {oil.name} <em>({formatPercent(oil.percent)}%)</em>
                  </span>
                  <strong className="recipe-sheet__list-value">
          ...
          <div className="recipe-sheet__stack">
            <section className="recipe-sheet__section">
              <div className="recipe-sheet__section-heading">
                <h2 className="recipe-sheet__section-title">Solution and Additives</h2>
                <p className="recipe-sheet__section-kicker">Lye solution and scented additions</p>
              </div>
              <div className="recipe-sheet__list">
              ...
              <p className="recipe-sheet__note">No additional additives entered.</p>
            </section>

            <section className="recipe-sheet__section">
              <div className="recipe-sheet__section-heading">
                <h2 className="recipe-sheet__section-title">Soap Qualities</h2>
                <p className="recipe-sheet__section-kicker">Calculated balance profile</p>
              </div>
